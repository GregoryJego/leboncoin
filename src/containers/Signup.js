...
"https://leboncoin-api.herokuapp.com/api/user/sign_up",
  ...
  alert("Les mots de passe sont différents");}
    ...
    >
      ...
      <div>"J’accepte les Conditions Générales de Vente et les Conditions Générales d’Utilisation"</div>
      </div><input className="modal-button" type="submit" value={"Créer mon Compte Personnel"} />
      </div>
    </form>
    </div>
  </div>);
